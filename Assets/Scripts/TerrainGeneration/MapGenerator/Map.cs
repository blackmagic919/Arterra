...
namespace Arterra.Config.Generation {
    ...
    public class Map : ScriptableObject {
        ...
        /// <summary>
        /// The name of the noise function within the <see cref="Arterra.Config.Config.GenerationSettings.Noise"/> registry of noise functions
        ...
        /// <summary> The index of the noise function described by <see cref="CaveFrequencyNoise"/> in the <see cref="Arterra.Config.Config.GenerationSettings.Noise">noise</see> registry </summary>
        [JsonIgnore]
        public int CaveFrequencyIndex => Config.CURRENT.Generation.Noise.RetrieveIndex(CaveFrequencyNoise);
        /// <summary> The index of the noise function described by <see cref="CaveSizeNoise"/> in the <see cref="Arterra.Config.Config.GenerationSettings.Noise">noise</see> registry </summary>
        [JsonIgnore]
        public int CaveSizeIndex => Config.CURRENT.Generation.Noise.RetrieveIndex(CaveSizeNoise);
        /// <summary> The index of the noise function described by <see cref="CaveShapeNoise"/> in the <see cref="Arterra.Config.Config.GenerationSettings.Noise">noise</see> registry </summary>
        [JsonIgnore]
        public int CaveShapeIndex => Config.CURRENT.Generation.Noise.RetrieveIndex(CaveShapeNoise);
        /// <summary> The index of the noise function described by <see cref="CoarseMaterialNoise"/> in the <see cref="Arterra.Config.Config.GenerationSettings.Noise">noise</see> registry </summary>
        [JsonIgnore]
        public int CoarseMaterialIndex => Config.CURRENT.Generation.Noise.RetrieveIndex(CoarseMaterialNoise);
        /// <summary> The index of the noise function described by <see cref="FineMaterialNoise"/> in the <see cref="Arterra.Config.Config.GenerationSettings.Noise">noise</see> registry </summary>
        [JsonIgnore]
        public int FineMaterialIndex => Config.CURRENT.Generation.Noise.RetrieveIndex(FineMaterialNoise);
        /// <summary> The index of the noise function described by <see cref="CoarseTerrainNoise"/> in the <see cref="Arterra.Config.Config.GenerationSettings.Noise">noise</see> registry </summary>
        [JsonIgnore]
        public int CoarseTerrainIndex => Config.CURRENT.Generation.Noise.RetrieveIndex(CoarseTerrainNoise);
        /// <summary> The index of the noise function described by <see cref="FineTerrainNoise"/> in the <see cref="Arterra.Config.Config.GenerationSettings.Noise">noise</see> registry </summary>
        [JsonIgnore]
