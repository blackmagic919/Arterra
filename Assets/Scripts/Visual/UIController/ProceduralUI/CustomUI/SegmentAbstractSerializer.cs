...
public class SegmentAbstractSerializer : IConverter
{
    ...
    public void Serialize(GameObject parent, FieldInfo field, object value, ParentUpdate OnUpdate)
    {
        ...
        Button buttonField = UnityEngine.Object.Instantiate(Resources.Load<GameObject>("Prefabs/SegmentedUI/Drop_Arrow"), optionContent).GetComponent<Button>(); 
        ...
        GameObject typeUI = UnityEngine.Object.Instantiate(Resources.Load<GameObject>("Prefabs/SegmentedUI/ExtendedType"), optionContent);
    ...
    private void CreateTypeList(GameObject parent, TextMeshProUGUI tText, FieldInfo field, ParentUpdate OnUpdate){
        ...
        foreach(Type cType in ConcretTypes){
            ...
            TextMeshProUGUI typeText = GetSegmentName(newOption);
