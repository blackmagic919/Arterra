...
namespace Arterra.Configuration.Quality{
    ...
    /// <seealso cref="MemoryBufferHandler"/>
    /// </summary>
    ...
    public class Memory : ScriptableObject
    {
        ...
        /// of free blocks within the <see cref="MemoryBufferHandler.Storage">Storage</see> buffer.
        ...
        /// <seealso cref="MemoryBufferHandler.Address"/>.
        /// </summary>
