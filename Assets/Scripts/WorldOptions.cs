...
public class WorldOptions : ScriptableObject{
    private static WorldOptions _current;
    private static WorldOptions _template;
    public static WorldOptions CURRENT{
        get => _current;
        set => _current = value;
    }
    
    public static WorldOptions TEMPLATE{
        get => _template;
        set => _template = value;
    }
    ...
    public struct SystemSettings{
        public Option<TerrainGeneration.Readback.ReadbackSettings> ReadBack;
    ...
    public static WorldOptions Create(){
        WorldOptions newOptions = Instantiate(TEMPLATE);
