...
namespace Arterra.Data.Entity.Behavior {
    ...
    public enum Behaviors {
        ...
        EntityItem = BehaviorTypes.Creature + 12,
        EntityItemDisplay = BehaviorTypes.Creature + 13,
        ProjectileTerrain = BehaviorTypes.Creature + 14,
        ProjectileFlight = BehaviorTypes.Creature + 15,
        ProjectileEffects = BehaviorTypes.Creature + 16,
        TestMerge = BehaviorTypes.Creature + 17,
        TimedDecay = BehaviorTypes.Creature + 18,
        ExplodedDecay = BehaviorTypes.Creature + 19,
    ...
    public class BehaviorEntity : Authoring
    {
        ...
        public static Dictionary<Behaviors, Func<Behavior>> BehaviorTemplates = new Dictionary<Behaviors, Func<Behavior>> {
            ...
            { Behaviors.EntityItem, () => new EntityItemBehavior()},
            { Behaviors.EntityItemDisplay, () => new EntityItemDisplayBehavior()},
            { Behaviors.ProjectileTerrain, () => new ProjectileTerrainBehavior()},
            { Behaviors.ProjectileFlight, () => new ProjectileFlightBehavior()},
            { Behaviors.ProjectileEffects, () => new ProjectileEffectsBehavior()},
            { Behaviors.TestMerge, () => new TestMergeBehavior()},
            { Behaviors.TimedDecay, () => new TimedDecayBehavior()},
            { Behaviors.ExplodedDecay, () => new ExplodedDecayBehavior()},
        ...
        public class AnimalSetting : EntitySetting, ISerializationCallbackReceiver, ICloneable{
            ...
            [TypeNameElementList("value",
                ...
                typeof(EntityItemSettings),
                typeof(EntityItemDisplaySettings),
                typeof(ProjectileTerrainSettings),
                typeof(ProjectileFlightSettings),
                typeof(ProjectileEffectsSettings),
                typeof(TestMergeSettings),
                typeof(TimedDecaySettings),
                typeof(ExplodedDecaySettings),
