...
public class Fox : Authoring
{
    ...
    private class FoxController {
        ...
        public FoxController(GameObject GameObject, FoxEntity entity){
            ...
            transform.position = CPUMapManager.GSToWS(GCoord - FoxEntity.settings.collider.offset) + (float3)Vector3.up * 1;
        }
        ...
        public void Update(){
            ...
            rTransform.position = CPUMapManager.GSToWS(rTransform.position - FoxEntity.settings.collider.offset);
