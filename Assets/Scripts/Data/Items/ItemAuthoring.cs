...
namespace Arterra.Data.Item {
    ...
    public class Authoring : Category<Authoring> {
        ...
        /// should store the index within <see cref="Config.GenerationSettings.Items"/> of the entry it 
    ...
    public class PlaceableItem : Authoring {
        /// <summary>
        /// The name of the entry within the <see cref="Config.GenerationSettings.Materials"> material registry </see>
