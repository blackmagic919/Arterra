...
public class DensityDeconstructor : MonoBehaviour
{
    ...
    private class ModelManager{
        ...
        new Material[2];
        private AsyncMeshReadback.GeometryHandle[] GeoHandles = 
        new AsyncMeshReadback.GeometryHandle[2];
        ...
        AsyncMeshReadback.GeometryHandle SetupGeoHandle(int vertStart, int indexStart, int indexCounter, int matInd){
