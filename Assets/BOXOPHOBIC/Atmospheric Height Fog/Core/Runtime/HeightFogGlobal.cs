    ...
    public class HeightFogGlobal : StyledMonoBehaviour
    {
        ...
        void Update()
        {
            ...
            else if (fogMode == FogMode.UseTimeOfDay)
            {
                ...
                {
                    presetDay.SetVector("_DirectionalDir", (mainDirectional.transform.forward == null) ? Vector3.one : -mainDirectional.transform.forward);
                    presetNight.SetVector("_DirectionalDir", (subDirectional.transform.forward == null) ? Vector3.one : -subDirectional.transform.forward);
